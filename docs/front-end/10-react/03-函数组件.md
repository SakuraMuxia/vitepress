...
![image-20240921100320163](https://kano-1303231448.cos.ap-nanjing.myqcloud.com//hanser/image-20240921100320163.png)
...
![image-20240923151034395](https://kano-1303231448.cos.ap-nanjing.myqcloud.com//hanser/image-20240923151034395.png)
...
产生这种现象的原因是：函数A嵌套函数B产生了闭包,函数B取不到函数A中的变量(缓存空间中的值)
